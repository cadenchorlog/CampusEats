...
class AppStateNotifier extends ChangeNotifier {
  CampusEatsFirebaseUser initialUser;
  CampusEatsFirebaseUser user;
  ...
  void update(CampusEatsFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Courier')
                  : CourierWidget(),
            ),
            FFRoute(
              name: 'History',
            ...
            FFRoute(
              ...
              path: 'courierChat',
              requireAuth: true,
              builder: (context, params) => CourierChatWidget(),
            ),
            FFRoute(
              name: 'Onboard',
              path: 'onboard',
            ...
            FFRoute(
              ...
              path: 'campusOnboarding',
              requireAuth: true,
              builder: (context, params) => CampusOnboardingWidget(),
            ),
            FFRoute(
              name: 'checkout',
              path: 'checkout',
